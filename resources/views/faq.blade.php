        ...
        @foreach($sections as $section)
            <div class="faq-theme">
                ...
                <div class="theme-container" id="theme-{{ $section->id }}">
                        <div id="less-{{ $section->id }}" class="hidden"><i class="fa-solid fa-chevron-down fa-xl"></i></div>
                        <div id="more-{{ $section->id }}"><i class="fa-solid fa-chevron-right fa-xl"></i></div>
                            ...
                            <div class="faq-header">
                                ...
                                @can('update', $faq)
                                    <div class="flex justify-between">
                                        <button class="p-2 bg rounded" onclick="openModel()">Bewerken</button>
